...
~~~sh
# getting the code
git clone git@github.com:nko5/better-the-nacl.git && cd ./better-the-nacl/
...
# deploying to Modulus (to http://better-the-nacl.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/better-the-nacl" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
